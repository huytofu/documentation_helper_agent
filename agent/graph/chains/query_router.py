...
- "vectorstore": for queries about LlamaIndex, Smolagents, LangGraph, CopilotKit (including Coagents), or related library/SDK docs we index (OpenAI API/SDK, Pinecone, and other curated package guides)
